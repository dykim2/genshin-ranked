...
<body>
  <nav>
    <ul>
      ...
      <a href="https://discord.gg/vRpFdTXQfh"> DISCORD </a>
    </ul>
  </nav>
  ...
  <div>
    ...
    <p style={{ fontSize: "12px" }}>
      ...
      <span style="color:lightgreen;"> OPEN, </span> <span style="color:yellow;">ADVANCED, </span> and <span
        style="color:red;">PREMIER</span>. These divisions are separated based
    ...
    ready with "r" or "ready" ref will type "Timer is ready, you have 15 seconds to begin" and you shall kill the
...
=======
>>>>>>> 6cbda1e (update rules.jsx to be once again compatible with jsx; add discord link)
