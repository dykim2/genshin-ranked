...
const selectionSlice = createSlice({
    ...
    reducers: {
        ...
        overrideBoss: (state, action: PayloadAction<number[]>) => {
            state.selectedBosses = action.payload;
        },
        overrideCharacter: (state, action: PayloadAction<{
            type: string,
            characters: number[]
        }>) => {
        ...
        overrideAllCharacters: (state, action: PayloadAction<{
            bans: number[],
            extraBans: number[],
            picksT1: number[],
            picksT2: number[]
            ...
            console.log("overriding all characters to ", bans, extraBans, picksT1, picksT2);
