...
export const CHARACTER_RESTRICTIONS: CharMap = {
    ...
    [CHARACTERS.Chasca]: {
        limit: 1,
        differences: [0,1],
        restrictions: ["Astral Vulture's Crimson Plumage", "Any 5* Weapon | R3+ Scion of The Sun | R3+ Flower-Wreathed Feathers"]
    },
    ...
    [CHARACTERS.Clorinde]: {
        limit: 2,
        differences: [0,1,2],
        restrictions: ["Absolution", "Any 5* Weapon | Black Sword | Sturdy Bone | Lion's Roar", "Any 3* Weapon"]
    },
    [CHARACTERS.Collei]: {
        limit: 6,
        differences: [-1],
    ...
    [CHARACTERS.Ganyu]: {
        limit: 5,
        differences: [1,3,4],
        restrictions: ["Astral Vulture's Crimson Plumage", "Any 5* Weapon | R3+ Scion of The Sun", "Any 4* Weapon"]
    },
    [CHARACTERS.Gorou]: {
        limit: 6,
        differences: [-1],
