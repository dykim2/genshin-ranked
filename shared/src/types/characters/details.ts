...
import { TEAM_BONUS } from "../teambonus";
...
export const CHARACTER_INFO: CharacterMap = {
	...
	[CHARACTERS.Chasca]: {
		...
		weapon: WEAPONS.bow,
		rarity: RARITY.FiveStar,
		bonus: TEAM_BONUS.chooseelement,
	...
	[CHARACTERS.Manekin]: {
		...
		rarity: RARITY.FiveStar,
		bonus: TEAM_BONUS.none,
		imageFileName: "Manekin",
		onlineFilePath: "https://thumbs4.imagebam.com/82/1d/ee/ME1A43JA_t.png",
		index: 105,
	},
	[CHARACTERS.Manekina]: {
		...
		rarity: RARITY.FiveStar,
		bonus: TEAM_BONUS.none,
		imageFileName: "Manekina",
		onlineFilePath: "https://thumbs4.imagebam.com/84/a0/d4/ME1A43JB_t.png",
		index: 106,
	},
	[CHARACTERS.Mavuika]: {
		displayName: "Mavuika",
