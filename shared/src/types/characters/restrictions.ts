...
export const CHARACTER_RESTRICTIONS: CharMap = {
    ...
    [CHARACTERS.Alhaitham]: {
        limit: 4,
        differences: [2, 3, 4],
        restrictions: ["Any 5* Weapon | R3+ Wolf-Fang", "Wolf-Fang | Harbinger of Dawn", "Any 3* Weapon"]
    },
    [CHARACTERS.Aloy]: {
        limit: 6,
        differences: [-1],
    ...
    [CHARACTERS.Bennett]: {
        limit: 6,
        differences: [5],
        restrictions: ["Any 674 Base Atk Weapon | Haran Geppaku Futsu | Freedom Sworn | Peak Patrol Song,"]
    },
    [CHARACTERS.Candace]: {
        limit: 6,
        differences: [-1],
    ...
    [CHARACTERS.Chasca]: {
        limit: 1,
        differences: [0, 1],
        restrictions: ["Astral Vulture's Crimson Plumage", "Any 5* Weapon | Scion of The Blazing Sun | Flower-Wreathed Feathers | Range Gauge"]
    },
    ...
    [CHARACTERS.Clorinde]: {
        limit: 2,
        differences: [0, 1, 2],
        restrictions: ["Absolution", "Any 5* Weapon | The Black Sword | Sturdy Bone | Lion's Roar", "Any 3* Weapon"]
    },
    [CHARACTERS.Collei]: {
        limit: 6,
        differences: [-1],
    ...
    [CHARACTERS.Cyno]: {
        limit: 6,
        differences: [2, 3, 6],
        restrictions: ["Staff of Scarlet Sands", "Primorial Jade-Winged Spear", "Any 3* Weapon"]
    },
    [CHARACTERS.Dehya]: {
        limit: 6,
        differences: [-1],
    ...
    [CHARACTERS.Ganyu]: {
        limit: 5,
        differences: [1, 3, 4],
        restrictions: ["Astral Vulture's Crimson Plumage", "Any 5* Weapon | R3+ Scion of The Blazing Sun", "Any 4* Weapon"]
    },
    [CHARACTERS.Gorou]: {
        limit: 6,
        differences: [-1],
    ...
    [CHARACTERS.Mualani]: {
        limit: 1,
        differences: [1],
        restrictions: ["Any 5* Weapon | R3+ Ring of Yaxche | Prototype Amber | Waveriding Whirl"]
    },
    [CHARACTERS.Nahida]: {
        limit: 6,
        differences: [3, 4, 6],
        restrictions: ["Thousand Floating Dreams", "Any 5* Weapon | Wandering Evenstar", "Any 3* Weapon"]
    },
    [CHARACTERS.Navia]: {
        limit: 1,
        differences: [0, 1],
    ...
    [CHARACTERS.Neuvillette]: {
        limit: 2,
        differences: [0, 1, 2],
        restrictions: ["Tome of The Eternal Flow", "Any 4* Weapon", "Any 3* Weapon"]
    },
    [CHARACTERS.Nilou]: {
        limit: 6,
        differences: [6],
    ...
    [CHARACTERS.Tighnari]: {
        limit: 5,
        differences: [2, 4],
        restrictions: ["Hunter's Path", "Any 5* Weapon | Scion of The Blazing Sun | R3+ Flower-Wreathed Feathers"]
    },
    [CHARACTERS.Traveler]: {
        limit: 6,
        differences: [-1],
